...
if typing.TYPE_CHECKING:
    from _template_bot.main import Client
    ...
    async def sync(self, ctx):
        ...
        if ctx.author.id == 680116696819957810:
            if len(messageStuff) != 0:
                ...
                await ctx.reply(
                    "Are you sure you want to sync app commands GLOBALLY? This process can take up to an hour!")
